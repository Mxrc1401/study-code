...
int main()
{
    ...
    for (int index = 0; index < 2; index++)
    {
        // Fehler vorher: play/print_info waren in den Derived-Klassen nicht exakt virtuell/const, und der Basisklassen-Destruktor war nicht virtuell.
        // Dadurch wurde Polymorphie unterlaufen und delete ueber den Basiszeiger war unsauber.
